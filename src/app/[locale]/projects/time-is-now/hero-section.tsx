...
export default function HeroSection() {
  return (
    <>
      <div
        className="container w-screen pt-64 pb-4 bg-auto bg-no-repeat flex flex-col items-center justify-center"
        style={{
      ...
      >
        <h1 className="flex items-center justify-center text-[#ffffff] font-bold ">
          TIMPUL ESTE ACUM 2023
        </h1>
        <div className="mt-96 w-2/3 flex flex-col gap-4 items-center justify-center text-[#ffffff] ">
          <h2 className="text-[#f3a61d] font-bold">
            URMĂREȘTE SERIA DE 15 EPISOADE
          </h2>
          <p className="border-b pb-4 border-[#ffffff] text-lg">
