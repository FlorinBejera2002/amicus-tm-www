  ...
  return (
    <div className="z-2 flex flex-col">
      <InViewTransition delay={0.95}>
        <div className="flex w-full flex-col gap-4 py-8 md:py-12">
      ...
      <div className="flex w-full flex-wrap border-t border-gray-800 pt-8">
        <InViewTransition delay={0.95}>
          <div className="flex flex-1 flex-col justify-center text-gray-800">
            <h2 className="!text-start md:pb-4 md:!text-center">
              {t('bottom-subtitle')}
            </h2>
