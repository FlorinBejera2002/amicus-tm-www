...
export default function Spotify() {
  ...
  return (
    <div className="bg-color-dark p-relative custom-section-1 lazyload bg-cover bg-center px-8 md:pb-12">
      <div className="container px-2 py-4 md:m-8">
            ...
            <div className="flex flex-1 flex-col justify-center text-white">
              ...
              <InViewTransition delay={0.65}>
                <div className="flex flex-col items-center gap-3">
                  <Link
                    className="w-72 cursor-pointer overflow-hidden rounded-md"
