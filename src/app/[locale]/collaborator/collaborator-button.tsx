...
export const CollaboratorButton = () => {
  ...
  const handleMailToClick = (e: { preventDefault: () => void }) => {
    e.preventDefault();
    window.location.href = 'mailto:info@ariseforchrist.com?subject=Vreau%20să%20mă%20implic&body=Mă%20numesc%20...%20și%20vreau%20să%20mă%20implic%20în%20lucrare';
  };
