  ...
  return (
    <div className="main" role="main">
      <section className="page-header p-relative bg-quaternary m-0 overflow-hidden border-0 p-0 ">
        <InViewTransition damping={100} delay={0.25} duration={0.5} yIn={0} yOut={0}>
          <CustomHeroBg />
        </InViewTransition>
            ...
            <InViewTransition delay={0.25}>
              <div className="py-4">
                <ul className="breadcrumb justify-content-center text-4-5 font-weight-medium mb-2 flex gap-2">
                  <li className="z-[1]">
                    <Link className="text-color-primary text-decoration-none" href="/">
                      {t("header.home")}
                    </Link>
                  </li>
                  <FaAngleRight className="text-color-primary z-[1] mt-0.5" />
                  <li className="text-color-primary active z-[1]">{t("header.donate")}</li>
                </ul>
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:flex-row xl:grid-cols-4">
                <InViewTransition delay={0.25}>
                  <div className=" flex w-full flex-col items-center justify-between gap-10 rounded-lg bg-gray-50 p-10 shadow-md md:h-96">
                    <Image alt="Logo for the bank" className="w-32" src={RevolutLogo} />
                    <div className="flex flex-col items-center justify-center text-center">
                      <div>
                        <p className="mb-1 font-semibold text-gray-700">{t("donate.phone")}</p>
                      ...
                      <Link
                        ...
                        target="_blank"
                      >
                        <Image alt="QR Code for donation" className="w-28" src={QRStripe} />
                      </Link>
                    </div>
                  </div>
                </InViewTransition>
                ...
                <InViewTransition delay={0.25}>
                  <div className="flex flex-col items-center justify-between gap-16 rounded-lg bg-purple-50 p-10 shadow-md md:h-96">
                    <Image alt="Logo for the bank" className="w-24" src={StripeLogo} />
                  ...
                  <div className=" flex w-full flex-col items-center justify-between gap-16 rounded-lg bg-blue-50 p-10 shadow-md md:h-96">
                    ...
                    <div className="flex flex-col items-center justify-center gap-10 text-center">
                      ...
                      <Link
                        ...
                        target="_blank"
                      >
                        <Image alt="QR Code for donation" className="w-[104px]" src={QRPayPal} />
                      </Link>
                    </div>
                  </div>
                </InViewTransition>
                ...
                <InViewTransition delay={0.25}>
                  <div className="flex flex-col items-center justify-between gap-6 rounded-lg bg-green-50 p-10 shadow-md md:h-96 lg:w-full">
                    ...
                    <div className="flex flex-col text-center gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="font-semibold text-gray-700">{t("donate.ron")}</span>
                        <span className="text-xs text-gray-600">RO36CECETM0130RON0998570</span>
                      </div>
                      <div className="flex flex-col gap-1">
                        <span className="font-semibold text-gray-700">{t("donate.dollars")}</span>
                        <span className="text-xs text-gray-600">RO37CECETM01B8USD0998572</span>
                      </div>
                    </div>
                  </div>
                </InViewTransition>
