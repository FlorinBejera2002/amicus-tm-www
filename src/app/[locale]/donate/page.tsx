      ...
      <div className="custom-page-content pb-4 p-relative z-index-2 text-md md:text-lg flex w-full justify-center">
        <div className="max-w-6xl flex flex-col lg:flex-row justify-around bg-white rounded-md p-8 gap-0 mt-4">
          <div className="flex-[1.75]">
            ...
            <p className=" text-gray-800 mb-4">{t('donate.paragraf_1')}</p>

            <p className=" text-gray-800 mb-4">{t('donate.paragraf_2')}</p>

            <p className=" text-gray-800 mb-4">{t('donate.paragraf_3')}</p>

            <p className=" text-gray-800 mb-4">{t('donate.paragraf_4')}</p>
          </div>
